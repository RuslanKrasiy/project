...
function registrar(){
    ...
    $form.="<form method='post' class='ui form' action=''>";
    ...
    $form.="<div class='required field'>";
        ...
        $form.="<div class='inline field'>";
                ...
                <a href='#'>Política de datos</a>, así como el uso que hacemos de la cookies y tecnologías similares
                en nuestra <a href='#'>Política de cookies</a>.</label>";
            $form.="</div>";
        $form.="</div>";
        $form.="<input type='submit' class='ui blue submit button' name='regi' value='Registrarse'>";
