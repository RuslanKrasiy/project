...
class Users{
	...
	public function signUp($link){
		$consult=$link->prepare("INSERT INTO clientes(nombre,apellido,email,passwd,fecha_nacim,fecha_reg) VALUES('$this->name','$this->lastName','$this->email','$this->pass','$this->birthDate',now())");
		$consult->execute();
    }
    /* 
